    ...
    <main className="sellYachts">
      ...
      <article className="sellYachts__hero">
        <div className=" sellYachts-hero-background">
          <motion.h1
            {...fadeInAnimSettings}
          >Sell Your Yacht</motion.h1>
          <motion.div
            className="heroParagraph"
            {...fadeInAnimSettings}
          >Unlock the potential of your yacht. Our experienced team will guide you through the process, ensuring a smooth and profitable sale.</motion.div>
        </div>
      </article>
      ...
      <div className="wrapper">
        <article
          ...
          <motion.h1
            className="sellYachts-intro-title"
            {...fadeInAnimSettings}
          >Sell Your Yacht with Ease and Confidence</motion.h1>
          <motion.div
      ...
      <article className="sellYachts__contact">
        ...
        <div className="wrapper">
          <motion.div
            className="sellYachts-info-title"
            {...fadeInAnimSettings}
          >
            <h2>Contact Us</h2>
